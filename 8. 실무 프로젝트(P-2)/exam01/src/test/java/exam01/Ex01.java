...
public class Ex01 {
    ...
    void test1() {
        try {
            ...
            e.printStackTrace(); // 동적 로딩 -> 사용할 때만 => 실행 시 작성
        }
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            String sql = "INSERT INTO MEMBER (USER_NO, USER_ID, USER_PW, USER_NM, MOBILE) VALUES (SEQ_MEMBER.NEXTVAL, 'USER01', '123456', '사용자01', '010-0000-0000')";
    ...
    void test2() {
        ...
        try(Connection conn = DriverManager.getConnection(url, user, password);
            Statement stmt = conn.createStatement()) {
            String keyword = "사용자"; // SQL 주입의 가능성 높다 -> 사용 지양

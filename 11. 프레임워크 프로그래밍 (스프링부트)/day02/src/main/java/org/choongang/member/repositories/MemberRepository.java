...
public interface MemberRepository extends JpaRepository<Member, Long>, QuerydslPredicateExecutor<Member> { // 프록시 형태로 JPA 가 다 만들어줌 | QuerydslPredicateExecutor<Member> : 추가된 인터페이스 -> 기존 틀에서 추가

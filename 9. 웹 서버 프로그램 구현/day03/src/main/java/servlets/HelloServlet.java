...
public class HelloServlet extends HttpServlet {
    ...
    } // web 은 모든 사람이 접근할 수 있어야 하므로 protected -> public 변경
    /*
    @Override
    ...
    */
    ...
    @Override
    public void init(ServletConfig config) throws ServletException { // 모든 값은 문자열 데이터로!
        // HelloServlet 만 조회 가능

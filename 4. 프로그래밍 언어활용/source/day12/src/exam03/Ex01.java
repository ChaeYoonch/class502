...
public class Ex01 {
    public static void main(String[] args) {
        ...
        CoffeeBean coffeeBean = new CoffeeBean(); // 초기화 작업 | 커피숍마다 다른 메뉴
        ...
        try {
            ...
            starBucks.enter(kim).order().exit(); // 아메리카노 주문. 입장. 퇴장
            coffeeBean.enter(lee).order().exit(); // 라떼 주문. 입장. 퇴장
        ...
        System.out.println("커피숍별 매출액 요약"); // 다형성 이용하여 정의
